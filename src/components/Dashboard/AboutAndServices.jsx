...
<Box sx={{ py: { xs: 8, md: 12 }, px: { xs: 2, md: 8 }, bgcolor: "#fff" }}>
  <Grid container spacing={6} alignItems="stretch" wrap="nowrap">
    {/* 1) Left column – text only (wider like your hero left) */}
    <Grid item xs={12} md={5} zeroMinWidth sx={{ minWidth: 0, pr: { md: 2 } }}>
      <Typography
        variant="h3"
        sx={{ fontWeight: 800, mb: 3, color: "#111", fontSize: { xs: 36, md: 56 }, lineHeight: 1.1 }}
      >
        Who we are ?
      </Typography>
      <Typography sx={{ color: "text.secondary", mb: 4, fontSize: { xs: 16, md: 20 }, lineHeight: 1.7 }}>
    ...
    {/* 2) Middle column – one tall image (narrower) */}
    ...
    {/* 3) Right column – two stacked images (medium width) */}
    <Grid item xs={12} md={4} zeroMinWidth sx={{ minWidth: 0 }}>
      <Box sx={{ height: { xs: "auto", md: 560 }, display: "flex", flexDirection: "column", gap: { xs: 3, md: 4 } }}>
        <Box
          component="img"
          src="/Registration.png"
